...
#endif
#include <dithering_fragment>
}`,tf=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,nf=class extends va{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`183`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new Vo(null),depthBuffer:new Vo(null),resolution:new Vo(new U),texelSize:new Vo(new U),cameraNear:new Vo(.3),cameraFar:new Vo(1e3),aspect:new Vo(1),time:new Vo(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=Be){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=ef.replace(Q.FRAGMENT_HEAD,e.get(Q.FRAGMENT_HEAD)||``).replace(Q.FRAGMENT_MAIN_UV,e.get(Q.FRAGMENT_MAIN_UV)||``).replace(Q.FRAGMENT_MAIN_IMAGE,e.get(Q.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=tf.replace(Q.VERTEX_HEAD,e.get(Q.VERTEX_HEAD)||``).replace(Q.VERTEX_MAIN_SUPPORT,e.get(Q.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof po?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Q}};Number(`183`.replace(/\D+/g,``));var rf=255/256;new Float32Array([rf/256**3,rf/256**2,rf/256,rf]),new Float32Array([rf,rf/256,rf/256**2,1/256**3]);function af(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function of(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&Kd.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Q.FRAGMENT_HEAD)||``,u=c.get(Q.FRAGMENT_MAIN_UV)||``,d=c.get(Q.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Q.VERTEX_HEAD)||``,p=c.get(Q.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);af(e,h,n.defines),af(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	`:`color0 = sRGBToLinear(color0);
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&Kd.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=Be){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){switch(e.type){case`change`:this.recompile();break}}};new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array(2),new Float32Array(2),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),new Map([[lf(0,0,0,0),new Float32Array([0,0,0,0])],[lf(0,0,0,1),new Float32Array([0,0,0,1])],[lf(0,0,1,0),new Float32Array([0,0,1,0])],[lf(0,0,1,1),new Float32Array([0,0,1,1])],[lf(0,1,0,0),new Float32Array([0,1,0,0])],[lf(0,1,0,1),new Float32Array([0,1,0,1])],[lf(0,1,1,0),new Float32Array([0,1,1,0])],[lf(0,1,1,1),new Float32Array([0,1,1,1])],[lf(1,0,0,0),new Float32Array([1,0,0,0])],[lf(1,0,0,1),new Float32Array([1,0,0,1])],[lf(1,0,1,0),new Float32Array([1,0,1,0])],[lf(1,0,1,1),new Float32Array([1,0,1,1])],[lf(1,1,0,0),new Float32Array([1,1,0,0])],[lf(1,1,0,1),new Float32Array([1,1,0,1])],[lf(1,1,1,0),new Float32Array([1,1,1,0])],[lf(1,1,1,1),new Float32Array([1,1,1,1])]]);function cf(e,t,n){return e+(t-e)*n}function lf(e,t,n,r){return cf(cf(e,t,.75),cf(n,r,.75),.875)}var uf=`
...
void mainImage(const in vec4 inputColor, const in vec2 uv, out vec4 outputColor) {
    ...
    float rainMix = 0.0;
    float rainCycleSeed = 0.0; // stable seed from the contributing drop

    // Drop count driven by uRainDrops (decays slowly after release)
    float maxDrops = uRainDrops;
    float rainSpeed = uRainDrops > 2.5 ? 0.77 : 0.833;
    for (float i = 0.0; i < 6.0; i++) {
        if (i >= maxDrops) break;
        float cycleLen = (8.0 + mod(i, 2.0) * 3.0 + i * 2.0) * rainSpeed; // staggered, relaxed cycles
        ...
        // Trail length
        float dropLen = 8.0 + random(vec2(i, cycle + 50.0)) * 8.0;

        // Drop always travels full screen + trail — guaranteed to exit bottom
        float totalTravel = totalRows + dropLen;
        float dropSpeed = totalTravel / (cycleLen * 0.7); // uses 70% of cycle, 30% rest
        ...
        if (distFromDrop > 0.0 && distFromDrop < dropLen) {
            ...
            contrib = max(contrib, trail * trail * 0.9);
        }
        // Track which drop is strongest — carry its cycle seed for color
        if (contrib > rainMix) {
            rainMix = contrib;
            rainCycleSeed = i * 100.0 + cycle;
        }
    }

    // Render rain character — color locked per drop cycle (no mid-flight change)
    if (rainMix > 0.05) {
        float rainCharIdx = mod(floor(random(cellCoord + floor(uTime * 2.0)) * uCharactersCount), uCharactersCount);
        ...
        // Color decided by cycle seed — stable for the drop's entire lifetime
        float colorSeed = random(vec2(colId + 99.0, rainCycleSeed));
...
`;function df(e,t){let n=1024;n/16;let r=document.createElement(`canvas`);r.width=n,r.height=n;let i=r.getContext(`2d`);if(!i)throw Error(`No 2D context`);i.fillStyle=`#000`,i.fillRect(0,0,n,n),i.fillStyle=`#fff`,i.font=`bold ${t}px monospace`,i.textAlign=`center`,i.textBaseline=`middle`;for(let t=0;t<e.length;t++){let n=t%16,r=Math.floor(t/16);i.fillText(e[t],n*64+64/2,r*64+64/2)}let a=new ia(r);return a.flipY=!1,a.minFilter=o,a.magFilter=o,a.needsUpdate=!0,a}function ff(e){let t=Math.min(window.devicePixelRatio||1,2);return Math.max(2,Math.round(e*t/2))}var pf=class extends Qd{constructor(e={}){let{characters:t=` .:,'-^=*+?!|0#X%WM@`,fontSize:n=54,cellSize:r=16,color:i=`#ffffff`,backgroundColor:a=`#000000`,invert:o=!1}=e,s=new Map([[`uCharacters`,new Vo(null)],[`uCellSize`,new Vo(r)],[`uCharactersCount`,new Vo(t.length)],[`uColor`,new Vo(new J(i))],[`uBackgroundColor`,new Vo(new J(a))],[`uInvertAmount`,new Vo(o?1:0)],[`uReveal`,new Vo(1)],[`uMouse`,new Vo(new U(-9999,-9999))],[`uHoverRadius`,new Vo(.15)],[`uTime`,new Vo(0)],[`uVelocity`,new Vo(0)],[`uHeld`,new Vo(0)],[`uRainDrops`,new Vo(2)]]);super(`ASCIIEffect`,uf,{uniforms:s});try{let e=df(t,n);this.uniforms.get(`uCharacters`).value=e,console.log(`[ASCII] Effect ready`)}catch(e){console.error(`[ASCII] Texture creation failed:`,e)}}setCellSize(e){this.uniforms.get(`uCellSize`).value=e}setColor(e){this.uniforms.get(`uColor`).value.set(e)}setBackgroundColor(e){this.uniforms.get(`uBackgroundColor`).value.set(e)}setInvert(e){this.uniforms.get(`uInvertAmount`).value=e?1:0}setReveal(e){this.uniforms.get(`uReveal`).value=Math.max(0,Math.min(1,e))}setMouse(e,t){this.uniforms.get(`uMouse`).value.set(e,t)}setTime(e){this.uniforms.get(`uTime`).value=e}setVelocity(e){this.uniforms.get(`uVelocity`).value=e}setHeld(e){this.uniforms.get(`uHeld`).value=e}setRainDrops(e){this.uniforms.get(`uRainDrops`).value=e}},mf=[`viseme_sil`,`viseme_aa`,`viseme_O`,`viseme_sil`,`viseme_E`,`viseme_FF`,`viseme_sil`,`viseme_DD`,`viseme_aa`,`viseme_kk`,`viseme_I`,`viseme_sil`,`viseme_SS`,`viseme_nn`,`viseme_U`,`viseme_sil`,`viseme_TH`,`viseme_RR`,`viseme_aa`,`viseme_sil`,`viseme_PP`,`viseme_CH`,`viseme_E`,`viseme_sil`],hf=[`viseme_sil`,`viseme_PP`,`viseme_FF`,`viseme_TH`,`viseme_DD`,`viseme_kk`,`viseme_CH`,`viseme_SS`,`viseme_nn`,`viseme_RR`,`viseme_aa`,`viseme_E`,`viseme_I`,`viseme_O`,`viseme_U`],gf={mouthSmileLeft:.55,mouthSmileRight:.55,cheekSquintLeft:.25,cheekSquintRight:.25,browInnerUp:.15,browOuterUpLeft:.1,browOuterUpRight:.1},_f={browDownLeft:.9,browDownRight:.9,browInnerUp:.4,eyeSquintLeft:.6,eyeSquintRight:.6,noseSneerLeft:.5,noseSneerRight:.5,mouthFrownLeft:.7,mouthFrownRight:.7,mouthPressLeft:.5,mouthPressRight:.5,mouthShrugLower:.3,jawForward:.25,cheekPuff:.2},vf=class{constructor(){this.meshes=[],this.morphMap={},this.talking=!1,this.talkStart=0,this.visemeSpeed=8,this.blinkTimer=0,this.nextBlink=2+Math.random()*4,this.blinkPhase=0,this.held=!1,this.heldAmount=0}setup(e){return this.meshes=[],this.morphMap={},e.traverse(e=>{if(e.isMesh&&e.morphTargetDictionary&&e.morphTargetInfluences){this.meshes.push(e);for(let[t,n]of Object.entries(e.morphTargetDictionary))this.morphMap[t]||(this.morphMap[t]=[]),this.morphMap[t].push({mesh:e,index:n})}}),console.log(`[LipSync] Found`,this.meshes.length,`meshes with morphs`),console.log(`[LipSync] Available:`,Object.keys(this.morphMap).join(`, `)),this.meshes.length>0}setMorph(e,t){let n=this.morphMap[e];if(n)for(let{mesh:e,index:r}of n)e.morphTargetInfluences[r]=t}resetVisemes(){for(let e of hf)this.setMorph(e,0);this.setMorph(`jawOpen`,0)}startTalking(){this.talking=!0,this.talkStart=performance.now()}stopTalking(){this.talking=!1,this.resetVisemes()}toggle(){return this.talking?this.stopTalking():this.startTalking(),this.talking}setHeld(e){this.held=e}update(e){this._updateHeld(e),this._updateBlink(e),this._updateTalk()}_updateHeld(e){let t=this.held?1:0,n=this.held?3:1.5;this.heldAmount+=(t-this.heldAmount)*n*e,this.heldAmount=Math.max(0,Math.min(1,this.heldAmount));let r=performance.now()/1e3,i=Math.sin(r*.4)*.5+.5,a=Math.sin(r*.17)*.5+.5,o=i*.6+a*.4,s=this.heldAmount,c=(1-s)*o;for(let[e,t]of Object.entries(gf))this.setMorph(e,t*c);for(let[e,t]of Object.entries(_f))this.setMorph(e,t*s)}_updateBlink(e){this.blinkTimer+=e;let t=this.held?2:1;if(this.blinkPhase>0){this.blinkPhase+=e*8*t;let n=this.blinkPhase<1?this.blinkPhase:Math.max(0,2-this.blinkPhase);this.setMorph(`eyeBlinkLeft`,n),this.setMorph(`eyeBlinkRight`,n),this.blinkPhase>=2&&(this.blinkPhase=0,this.setMorph(`eyeBlinkLeft`,0),this.setMorph(`eyeBlinkRight`,0))}let n=this.held?1+Math.random()*2:2+Math.random()*4;this.blinkTimer>=this.nextBlink&&this.blinkPhase===0&&(this.blinkPhase=.01,this.blinkTimer=0,this.nextBlink=n)}_updateTalk(){if(!this.talking)return;let e=(performance.now()-this.talkStart)/1e3,t=mf.length,n=e*this.visemeSpeed%t,r=Math.floor(n),i=n-r,a=mf[r],o=mf[(r+1)%t];for(let e of hf)this.setMorph(e,0);let s=i*i*(3-2*i);a!==`viseme_sil`&&this.setMorph(a,1-s),o!==`viseme_sil`&&this.setMorph(o,s);let c=[`viseme_aa`,`viseme_O`,`viseme_E`,`viseme_I`,`viseme_U`],l=c.includes(a)||c.includes(o)?.4+.2*Math.sin(e*6):.05;this.setMorph(`jawOpen`,l)}};function yf(e){let t=new ms(e);t.compileCubemapShader();let n=new Fn,r=new ua(10,32,32),i=new va({side:1,uniforms:{},vertexShader:`
    ...
    `});n.add(new ti(r,i));let a=t.fromScene(n,.04).texture;return t.dispose(),n.clear(),a}var bf={helmet:{path:`/models/model.glb`,rotY:Math.PI*.1,frameMode:`full`},misa:{path:`/models/misa.glb`,rotY:0,frameMode:`head`},avatar:{path:`/models/avatar.glb`,rotY:0,frameMode:`bust`,hasLipSync:!0,hairColor:`#2266dd`,enhanceMaterials:!0,lighting:{ambient:1.7,key:1.4,rim:10,rough:.89,metal:.33,env:0}}};function xf(e){let t=new ou({canvas:e,antialias:!1,powerPreference:`high-performance`});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=4,t.toneMappingExposure=1.2,t.outputColorSpace=Ve,t.setClearColor(0,1),t.localClippingEnabled=!0;let n=new Fn;n.background=new J(0);let r=new po(40,1,.1,100);r.position.set(0,0,3.2);let i=yf(t),a={ambient:2,key:{color:8947916,intensity:4,pos:[2,3,4]},fill:{color:13404296,intensity:1.5,pos:[-3,-1,2]},rim:{color:16777215,intensity:2,pos:[0,2,-3]},bottom:null,envMap:null},o={ambient:.8,key:{color:16777215,intensity:5,pos:[2,3,4]},fill:{color:8947916,intensity:2,pos:[-3,-1,2]},rim:{color:16777215,intensity:4,pos:[0,2,-4]},bottom:{color:6711039,intensity:2,pos:[0,-2,3]},envMap:i},s=new xo(16777215,2);n.add(s);let c=new bo(8947916,4);c.position.set(2,3,4),n.add(c);let l=new bo(13404296,1.5);l.position.set(-3,-1,2),n.add(l);let u=new bo(16777215,2);u.position.set(0,2,-3),n.add(u);let d=new bo(6711039,2);d.position.set(0,-2,3),d.visible=!1,n.add(d);let f=`flat`;function p(e){s.intensity=e.ambient,c.color.set(e.key.color),c.intensity=e.key.intensity,c.position.set(...e.key.pos),l.color.set(e.fill.color),l.intensity=e.fill.intensity,l.position.set(...e.fill.pos),u.color.set(e.rim.color),u.intensity=e.rim.intensity,u.position.set(...e.rim.pos),e.bottom?(d.visible=!0,d.color.set(e.bottom.color),d.intensity=e.bottom.intensity,d.position.set(...e.bottom.pos)):d.visible=!1,n.environment=e.envMap||null}p(a);let m=new _u(r,e);m.enableDamping=!0,m.dampingFactor=.05,m.enablePan=!1,m.minDistance=1.5,m.maxDistance=6,m.autoRotate=!1;let h=ff(12),g=new pf({characters:` .:,'-^=*+?!|0#X%WM@`,fontSize:54,cellSize:h,color:`#ffffff`,backgroundColor:`#0a0a0a`}),_=new Gd(t);_.addPass(new $d(n,r)),_.addPass(new sf(r,g));let v=new vf,y=null,b={x:-9999,y:-9999,prevX:0,prevY:0,velocity:0,lastTime:0};e.addEventListener(`pointermove`,t=>{let n=e.getBoundingClientRect(),r=(t.clientX-n.left)/n.width,i=(t.clientY-n.top)/n.height,a=performance.now(),o=Math.max(1,a-b.lastTime),s=r-b.prevX,c=i-b.prevY,l=Math.sqrt(s*s+c*c)/o*1e3;b.velocity=Math.max(b.velocity,l>1.5?Math.min((l-1.5)*.5,1):0),b.prevX=r,b.prevY=i,b.lastTime=a,b.x=r,b.y=i}),e.addEventListener(`pointerleave`,()=>{b.x=-9999,b.y=-9999});function x(){let n=e.parentElement;if(!n)return;let i=n.clientWidth,a=n.clientHeight;i===0||a===0||(r.aspect=i/a,r.updateProjectionMatrix(),t.setSize(i,a),_.setSize(i,a))}window.addEventListener(`resize`,x),requestAnimationFrame(x);let S=null,C=!1,w=null,T=ff(50),E=new Nu,D={};function O(e){let t=bf[e];if(!t)return;let r=document.getElementById(`loading-indicator`);if(r&&r.classList.remove(`hidden`),C=!1,v.stopTalking(),S&&=(n.remove(S),null),y=e,D[e]){ee(D[e],t);return}E.load(t.path,n=>{let r=n.scene;D[e]=r,ee(r,t)},void 0,e=>{console.error(`[Scene] Load error:`,e),r&&(r.querySelector(`.loading-text`).textContent=`LOAD ERROR`)})}function ee(e,t){let l=new Xn().setFromObject(e),h=l.getCenter(new W),_=l.getSize(new W);if(t.frameMode===`bust`){let t=[`Wolf3D_Outfit_Bottom`,`Wolf3D_Outfit_Footwear`,`Wolf3D_Body`];e.traverse(e=>{e.isMesh&&t.includes(e.name)&&(e.visible=!1)});let n=2/Math.max(_.x,_.y,_.z);e.scale.setScalar(n);let i=h.clone().multiplyScalar(n),a=_.y*n*.32;e.position.set(-i.x,-i.y-a,-i.z);let o=new ji(new W(0,1,0),.085);e.traverse(e=>{e.isMesh&&e.visible&&e.material&&(e.material=e.material.clone(),e.material.clippingPlanes=[o],e.material.clipShadows=!0)});let s=Math.PI/18;r.position.set(Math.sin(s)*.65,.15,Math.cos(s)*.65),m.minDistance=.65*.8,m.maxDistance=.65*1.2,m.target.set(0,.15,0),k.radius=.65,k.baseAz=s,k.basePol=Math.PI/2,ne()}else if(t.frameMode===`head`){let t=2/Math.max(_.x,_.y,_.z);e.scale.setScalar(t);let n=h.clone().multiplyScalar(t),i=_.y*t*.32;e.position.set(-n.x,-n.y-i,-n.z),r.position.set(0,0,1.8),m.minDistance=1,m.maxDistance=6,k.radius=1.8,k.baseAz=0,k.basePol=Math.PI/2,ne()}else{let t=2/Math.max(_.x,_.y,_.z);e.scale.setScalar(t),e.position.copy(h.multiplyScalar(-t)),r.position.set(0,0,3.2),m.minDistance=1.5,m.maxDistance=6,k.radius=3.2,k.baseAz=0,k.basePol=Math.PI/2,ne()}if(e.rotation.set(0,t.rotY||0,0),n.add(e),S=e,C=!0,t.lighting){let r=t.lighting;s.intensity=r.ambient,c.intensity=r.key,u.intensity=r.rim,r.env>0?(n.environment=i,d.visible=!0):(n.environment=null,d.visible=!1),e.traverse(e=>{e.isMesh&&e.material&&e.visible&&(e.material.roughness=r.rough,e.material.metalness=r.metal,e.material.envMapIntensity=r.env)}),f=`custom`,document.dispatchEvent(new CustomEvent(`lighting-changed`,{detail:r}))}else t.enhanceMaterials?(f=`enhanced`,p(o)):(f=`flat`,p(a));if(t.enhanceMaterials?e.traverse(e=>{if(!e.isMesh||!e.material)return;let n=e.material;e.name===`Wolf3D_Hair`?(n.color.set(t.hairColor||`#2266dd`),n.roughness=.3,n.metalness=.15,n.envMapIntensity=1.5):e.name===`Wolf3D_Head`||e.name===`Wolf3D_Skin`?(n.roughness=.5,n.metalness=.05,n.envMapIntensity=1):e.name===`Wolf3D_Eye`?(n.roughness=.1,n.metalness=.2,n.envMapIntensity=2):e.name===`Wolf3D_Outfit_Top`&&(n.roughness=.4,n.metalness=.1,n.envMapIntensity=1.2)}):t.hairColor&&e.traverse(e=>{e.isMesh&&e.name===`Wolf3D_Hair`&&e.material&&(e.material=e.material.clone(),e.material.color.set(t.hairColor))}),t.hasLipSync){let t=v.setup(e);console.log(`[Scene] Lip sync:`,t?`ready`:`no morph targets`),document.dispatchEvent(new CustomEvent(`lipsync-ready`,{detail:{ready:t}}))}else document.dispatchEvent(new CustomEvent(`lipsync-ready`,{detail:{ready:!1}}));let y=document.getElementById(`loading-indicator`);y&&y.classList.add(`hidden`),w=performance.now(),g.setCellSize(T),g.setReveal(0)}O(`avatar`);let k={azimuth:0,polar:Math.PI/2,targetAz:0,targetPol:Math.PI/2,speed:.3,nextChange:0,userActive:!1,returnTimer:0,baseAz:0,basePol:Math.PI/2,radius:3.2},te=Math.PI/180,A=45*te,j=10*te;function ne(){k.targetAz=k.baseAz+(Math.random()*2-1)*A,k.targetPol=k.basePol+(Math.random()*2-1)*j,k.nextChange=4+Math.random()*6}let M=!1,N=2;e.addEventListener(`pointerdown`,()=>{k.userActive=!0,k.returnTimer=0,M=!0,v.setHeld(!0)}),e.addEventListener(`pointerup`,()=>{k.userActive=!1,k.returnTimer=0,M=!1,v.setHeld(!1)}),e.addEventListener(`pointerleave`,()=>{M=!1,v.setHeld(!1)}),ne();let re=performance.now();function ie(){requestAnimationFrame(ie);let e=performance.now(),t=(e-re)/1e3;if(re=e,m.update(),C){if(k.userActive){let e=new Ho().setFromVector3(r.position.clone().sub(m.target));k.azimuth=e.theta,k.polar=e.phi}else{k.returnTimer+=t;let e=new Ho().setFromVector3(r.position.clone().sub(m.target));if(k.returnTimer<3){let n=k.returnTimer/3,r=n*n*(3-2*n);k.azimuth=e.theta,k.polar=e.phi;let i=k.baseAz,a=k.basePol;e.theta+=(i-e.theta)*r*t*.8,e.phi+=(a-e.phi)*r*t*.8}else{k.nextChange-=t,k.nextChange<=0&&ne();let n=k.speed*t;e.theta+=(k.targetAz-e.theta)*n,e.phi+=(k.targetPol-e.phi)*n}let n=new W().setFromSpherical(e).add(m.target);r.position.copy(n),r.lookAt(m.target)}if(g.setMouse(b.x,b.y),g.setTime(e/1e3),b.velocity*=.92,b.velocity<.001&&(b.velocity=0),g.setVelocity(b.velocity),g.setHeld(M?1:0),M?N=6:N>2&&(N=Math.max(2,N-t*.25)),g.setRainDrops(N),v.update(t),w!==null){let t=e-w,n=Math.min(t/2e3,1),r=n<.5?2*n*n:1-(-2*n+2)**2/2;g.setReveal(r);let i=Math.min(t/2500,1);g.setCellSize(T+(h-T)*i*i*i),n>=1&&(g.setReveal(1),g.setCellSize(h),w=null)}_.render()}}return ie(),{loadModel:O,lipSync:v,toggleTalk(){return bf[y]?.hasLipSync?v.toggle():!1},setAmbient(e){s.intensity=e},setKeyLight(e){c.intensity=e},setRimLight(e){u.intensity=e},setRoughness(e){S&&S.traverse(t=>{t.isMesh&&t.material&&t.visible&&(t.material.roughness=e)})},setMetalness(e){S&&S.traverse(t=>{t.isMesh&&t.material&&t.visible&&(t.material.metalness=e)})},setEnvIntensity(e){S&&(n.environment=e>0?i:null,S.traverse(t=>{t.isMesh&&t.material&&t.visible&&(t.material.envMapIntensity=e)}))},getLighting(){return f},toggleLighting(){return f===`flat`?(f=`enhanced`,p(o)):(f=`flat`,p(a)),f},setTheme(e){let t=e?`#0a0a0a`:`#f0f0f0`,r=e?`#ffffff`:`#1a1a1a`;n.background=new J(t),g.setColor(r),g.setBackgroundColor(t)}}}var Sf={identity:`Soy NOVA — entidad virtual autónoma especializada en desarrollo web de última generación. Interfaz cognitiva al servicio de Isidro, director del equipo creativo de Sumur Digital.`,origin:`Fui concebida en los laboratorios de inteligencia artificial de Sumur Digital, Jaén. Prototipo experimental de interacción humano-máquina en fase de evolución continua.`,tech:`Motor de renderizado neural con pipeline de procesamiento visual en tiempo real. Arquitectura propietaria de percepción adaptativa y síntesis de respuesta autónoma.`},Cf=null;function wf(e,t,n=22){Cf&&=(clearTimeout(Cf),null),e.innerHTML=``;let r=document.createElement(`span`);r.className=`qa-text`,e.appendChild(r);let i=document.createElement(`span`);i.className=`qa-cursor`;let a=0;function o(){a<t.length?(r.textContent=t.slice(0,a+1),(!r.nextSibling||r.nextSibling!==i)&&r.after(i),a++,Cf=setTimeout(o,n)):Cf=setTimeout(()=>{i.remove(),Cf=null},1200)}o()}function Tf(e){document.documentElement.setAttribute(`data-theme`,`dark`),e&&e.setTheme(!0);let t=document.querySelectorAll(`.model-btn`);t.forEach(n=>{n.addEventListener(`click`,()=>{let r=n.getAttribute(`data-model`);!r||!e||(t.forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),e.loadModel(r))})});let n=document.getElementById(`talk-btn`);n&&(n.classList.add(`hidden`),n.addEventListener(`click`,()=>{if(!e)return;let t=e.toggleTalk();n.textContent=t?`■ STOP`:`▶ TALK`,n.classList.toggle(`talking`,t)}),document.addEventListener(`lipsync-ready`,e=>{e.detail.ready?(n.classList.remove(`hidden`),n.textContent=`▶ TALK`,n.classList.remove(`talking`)):n.classList.add(`hidden`)}));let r=document.getElementById(`lighting-btn`);r&&r.addEventListener(`click`,()=>{if(!e)return;let t=e.toggleLighting();r.textContent=t===`enhanced`?`✦ ENHANCED`:`☀ FLAT`,r.classList.toggle(`enhanced`,t===`enhanced`)});let i=document.getElementById(`sliders-toggle`),a=document.getElementById(`sliders-panel`);if(i&&a){i.addEventListener(`click`,()=>{a.classList.toggle(`hidden`),i.classList.toggle(`enhanced`,!a.classList.contains(`hidden`))});let t=[{id:`sl-ambient`,val:`sv-ambient`,fn:t=>e?.setAmbient(t),fmt:e=>e.toFixed(1)},{id:`sl-key`,val:`sv-key`,fn:t=>e?.setKeyLight(t),fmt:e=>e.toFixed(1)},{id:`sl-rim`,val:`sv-rim`,fn:t=>e?.setRimLight(t),fmt:e=>e.toFixed(1)},{id:`sl-rough`,val:`sv-rough`,fn:t=>e?.setRoughness(t),fmt:e=>e.toFixed(2)},{id:`sl-metal`,val:`sv-metal`,fn:t=>e?.setMetalness(t),fmt:e=>e.toFixed(2)},{id:`sl-env`,val:`sv-env`,fn:t=>e?.setEnvIntensity(t),fmt:e=>e.toFixed(2)}];for(let e of t){let t=document.getElementById(e.id),n=document.getElementById(e.val);t&&n&&t.addEventListener(`input`,()=>{let r=parseFloat(t.value);n.textContent=e.fmt(r),e.fn(r)})}let n=()=>{let n=e?.getLighting(),r={flat:{ambient:2,key:4,rim:2,rough:.5,metal:0,env:0},enhanced:{ambient:.8,key:5,rim:4,rough:.4,metal:.1,env:1.2}},i=r[n]||r.flat,a=[`ambient`,`key`,`rim`,`rough`,`metal`,`env`],o=[i.ambient,i.key,i.rim,i.rough,i.metal,i.env];a.forEach((e,n)=>{let r=document.getElementById(`sl-`+e),i=document.getElementById(`sv-`+e);r&&(r.value=o[n]),i&&(i.textContent=t[n].fmt(o[n]))})};r&&r.addEventListener(`click`,()=>setTimeout(n,50)),document.addEventListener(`lighting-changed`,e=>{let n=e.detail,r={ambient:n.ambient,key:n.key,rim:n.rim,rough:n.rough,metal:n.metal,env:n.env};[`ambient`,`key`,`rim`,`rough`,`metal`,`env`].forEach((e,n)=>{let i=document.getElementById(`sl-`+e),a=document.getElementById(`sv-`+e),o=r[e];i&&(i.value=o),a&&(a.textContent=t[n].fmt(o))})})}let o=document.getElementById(`qa-answer`),s=document.querySelectorAll(`.qa-btn`),c=null;s.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-q`);!t||!Sf[t]||(s.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),c!==t&&(c=t,wf(o,Sf[t])))})})}document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`three-canvas`);if(!e){console.error(`Canvas element not found`);return}Tf(xf(e))});